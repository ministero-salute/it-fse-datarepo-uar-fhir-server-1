 ...
 */
@Component
public class GravidanzaProvider {
    ...
    @Operation(name = "$gravidanza", idempotent = true, returnParameters = {@OperationParam(name = "return", type = Bundle.class)})
    public Bundle cercaPacchetto(@OperationParam(name = "publisher") StringType publisher, RequestDetails requestDetails) {
    	String system = "";
    	return engineComponent.getBundle("GRAVIDANZA", system , publisher.getValue());
    }
